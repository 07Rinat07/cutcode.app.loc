                    ...
                    <div id="task-comments" class="pt-4">
                        ...
                        <div
                            ...
                            <div class="flex flex-row justify-center mr-2">
                                <h3 class="text-purple-600 font-semibold text-lg text-center md:text-left ">Иванов
                                    Иван</h3>
                            </div>


                            <p style="width: 90%" class="text-gray-600 text-lg text-center md:text-left ">Отличная
                                статья</p>
                        </div>
                        <!--  comment end-->
                    </div>
